...
then
    cd ~/myblog && cp index.html tmp.html && cp index_bak.html index.html && rm -r _site/ && jekyll serve --incremental --watch && cp _site/index.html index2.html && cp tmp.html index.html && echo congratulations! generate new _site content finished.
