...
a = requests.get("https://www.vultr.com/faq/")
html = a.text
a = re.search(
    r"Download Test File:([\s\S]+)Port X seems to be blocked on my VPS", html, re.I).group(1)
a = re.findall(
...
print("quickest is:\n" + quickest_name + "," +
      quickest_address + "," + str(quickest_time) + "ms")
