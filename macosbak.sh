...
if [ ! -d $bakupdevice ]; then
    ...
    if [ -f $bakupfile1 -a -f $bakupfile2 ]; then
        ...
        tar cvpzf $bakupfile2 --exclude=/macosbak/macosbak1.tgz --exclude=/macosbak/macosbak2.tgz --exclude=/Volumes --exclude="/Library/Application Support" --exclude=/Library/Caches --exclude=~/.cache --exclude=/private/var/log --exclude=~/.Trash --exclude="~/Documents/Virtual Machines.localized" --exclude=~/Downloads --exclude=~/Library/Caches --exclude=/private/var/tmp --exclude=/private/var/vm /
    elif [ ! -f $bakupfile1 -a ! -f $bakupfile2 ]; then
        echo "bakupfile1 not exist,bakupfile2 not exist"
        tar cvpzf $bakupfile1 --exclude=/macosbak/macosbak1.tgz --exclude=/macosbak/macosbak2.tgz --exclude=/Volumes --exclude="/Library/Application Support" --exclude=/Library/Caches --exclude=~/.cache --exclude=/private/var/log --exclude=~/.Trash --exclude="~/Documents/Virtual Machines.localized" --exclude=~/Downloads --exclude=~/Library/Caches --exclude=/private/var/tmp --exclude=/private/var/vm /
    elif [ -f $bakupfile1 -a ! -f $bakupfile2 ]; then
